...
function CivTree({civs}: Props) {
    ...
    const selectedCivName = selectedCivKey ? CIV_KEY_TO_NAME.get(selectedCivKey) : ""
    ...
    return (
        <div className="flex flex-column bg-bluegray-900 border-1 border-yellow-200">
            <div className="flex flex-row justify-content-between p-1">
                <div className={"flex flex-column justify-content-center text-xl uppercase text-yellow-200 p-2"}>
                    {selectedCivName}
                </div>
                <Dropdown
                    style={{width: "240px"}}
            ...
            <div
                className="grid grid-nogutter bg-yellow-900 text-gray-100 text-lg border-bottom-1 border-yellow-200">
                <div
                    className="col-3 flex flex-row flex-1 justify-content-center gap-3 border-right-1 border-yellow-200 p-3">
